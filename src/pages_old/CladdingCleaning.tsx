        ...
        <div className="container-custom section-padding">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" size="lg" asChild>
              <Link to="/contact" title="Request professional cladding cleaning quote">
                Request Quote
              </Link>
            </Button>
          </div>
      ...
      <div className="container-custom section-padding">
        <div className="max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/services/pressure-washing" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
              ...
              <Link to="/services/render-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
              ...
              <Link to="/services/roof-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
              ...
              <Link to="/services/gutter-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
              ...
              <Link to="/services/exterior-cleaning" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary md:col-span-2">
