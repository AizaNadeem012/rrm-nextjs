      ...
      <section className="section-padding bg-secondary/50">
        <div className="container-custom">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link to="/services/pressure-washing" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
            ...
            <Link to="/services/driveway-cleaning" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
              <h3 className="font-display font-semibold text-foreground group-hover:text-accent mb-2">
            ...
            <Link to="/services/roof-cleaning" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
              <h3 className="font-display font-semibold text-foreground group-hover:text-accent mb-2">
            ...
            <Link to="/services/gutter-cleaning" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
              <h3 className="font-display font-semibold text-foreground group-hover:text-accent mb-2">
            ...
            <Link to="/services/window-cleaning" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
              <h3 className="font-display font-semibold text-foreground group-hover:text-accent mb-2">
                Window Cleaning in {area.name}
              </h3>
              <p className="text-sm text-muted-foreground">Crystal-clear results with pure water technology.</p>
            </Link>
            <Link to="/services/render-cleaning" className="group p-5 rounded-xl bg-card border border-border/50 hover:border-accent/30 hover:shadow-md transition-all">
              <h3 className="font-display font-semibold text-foreground group-hover:text-accent mb-2">
