      ...
      <nav className="bg-secondary/50" aria-label="Breadcrumb">
        <div className="container-custom py-4">
          <ol className="flex items-center gap-2 text-sm flex-wrap">
            <li><Link to="/" className="text-primary hover:text-accent transition-colors">Home</Link></li>
            <li className="text-primary-foreground/50"><ChevronRight className="h-4 w-4" /></li>
            <li><Link to="/services/exterior-cleaning" className="text-primary hover:text-accent transition-colors">Exterior Cleaning</Link></li>
            <li className="text-primary-foreground/50"><ChevronRight className="h-4 w-4" /></li>
        ...
        <div className="container-custom section-padding">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" size="lg" asChild>
              <Link to="/contact" title="Request professional exterior cleaning quote">
                Request Quote
              </Link>
            </Button>
          </div>
        ...
        <div className="max-w-4xl">
          ...
          <section className="mt-12 pt-12 border-t border-secondary">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              <Link to="/services/pressure-washing" className="group p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary text-center">
              ...
              <Link to="/services/soft-washing" className="group p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary text-center">
              ...
              <Link to="/services/roof-cleaning" className="group p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary text-center">
              ...
              <Link to="/services/gutter-cleaning" className="group p-4 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary text-center">
