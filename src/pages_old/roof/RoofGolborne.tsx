      ...
      '@graph': [
        {
          ...
          email: 'info@rrmexternalcleaningspecialist.co.uk',
          address: {
            '@type': 'PostalAddress',
          ...
          <div className="container-custom py-4">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <Link to="/" itemProp="item" className="text-primary hover:text-accent transition-colors">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <Link to="/services/roof-cleaning" itemProp="item" className="text-primary hover:text-accent transition-colors">
          ...
          <div className="container-custom section-padding">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" asChild>
                <Link to="/contact" title="Request professional roof inspection in Golborne">
          ...
          <div className="max-w-4xl">
            ...
            <section className="bg-gradient-to-r from-accent/20 to-primary/20 rounded-lg p-8 border border-accent/30 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                ...
                <Button variant="outline" size="lg" asChild>
                  <Link to="/contact">Request Free Inspection</Link>
                </Button>
              </div>
            ...
            <section className="mt-12 pt-12 border-t border-secondary">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Link to="/services/gutter-cleaning/golborne" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
                ...
                <Link to="/services/pressure-washing/golborne" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
                  <h3 className="font-semibold text-foreground group-hover:text-accent transition-colors mb-2">
                ...
                <Link to="/services/soft-washing/golborne" className="group p-6 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors border border-secondary">
                  <h3 className="font-semibold text-foreground group-hover:text-accent transition-colors mb-2">
