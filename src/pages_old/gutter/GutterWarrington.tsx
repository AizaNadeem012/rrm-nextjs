              ...
              <Fragment key={crumb.url}>
                ...
                <li>
                  {index === breadcrumbs.length - 1 ? (
                    ...
                    <Link to={crumb.url} className="text-primary hover:text-accent transition-colors">{crumb.name}</Link>
                  )}
                </li>
              </Fragment>
            ))}
        ...
        <div className="container-custom section-padding">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" size="lg" asChild>
              <Link to="/contact" title="Request professional gutter cleaning assessment">
                Request Assessment
              </Link>
            </Button>
          </div>
