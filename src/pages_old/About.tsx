            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg bg-secondary/30">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">We match our cleaning method to the surface type—high pressure for tough surfaces, soft washing for delicate ones.</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 rounded-lg bg-secondary/30">
                <CheckCircle className="h-6 w-6 text-success shrink-0 mt-0.5" />
