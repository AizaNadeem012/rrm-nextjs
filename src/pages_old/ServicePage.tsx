...
export default function ServicePage() {
  ...
  return (
    <Layout>
      <Helmet>
        <title>{service.title} Services in Newton-le-Willows | R.R.M Exterior Cleaning</title>
        <meta name="description" content={service.description} />
        <link rel="canonical" href={`https://www.rrmexternalcleaningspecialist.co.uk/services/${serviceSlug}`} />
        <meta property="og:title" content={`${service.title} Services in Newton-le-Willows | R.R.M Exterior Cleaning`} />
        <meta property="og:description" content={service.description} />
        <meta property="og:url" content={`https://www.rrmexternalcleaningspecialist.co.uk/services/${serviceSlug}`} />
        <script type="application/ld+json">
          {JSON.stringify(serviceSchema(service.title, service.longDescription))}
        </script>
        <script type="application/ld+json">
          {JSON.stringify(faqSchema(service.faqs.map(faq => ({ question: faq.q, answer: faq.a }))))}
        </script>
        <script type="application/ld+json">
