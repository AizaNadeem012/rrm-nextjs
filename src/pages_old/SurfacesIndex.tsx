    ...
    <>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                <li>• Timber and Wood</li>
                <li>• Roof Tiles and Gutters</li>
              </ul>
            </div>
      ...
      <section className="bg-green-600 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Help Identifying Your Surface Type?</h2>
          <p className="text-xl mb-6">
            Contact our team for expert advice on the best cleaning approach for your property
          </p>
